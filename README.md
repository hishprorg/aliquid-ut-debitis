...
[![Coverage Status](https://coveralls.io/repos/github/hishprorg/aliquid-ut-debitis/badge.svg)](https://coveralls.io/github/hishprorg/aliquid-ut-debitis)
[![ci](https://github.com/hishprorg/aliquid-ut-debitis/actions/workflows/ci.yml/badge.svg)](https://github.com/hishprorg/aliquid-ut-debitis/actions/workflows/ci.yml)
[![NPM Version](https://img.shields.io/npm/v/@hishprorg/aliquid-ut-debitis.svg)](https://www.npmjs.com/package/@hishprorg/aliquid-ut-debitis)
[![NPM Downloads](https://img.shields.io/npm/dm/@hishprorg/aliquid-ut-debitis.svg)](http://npm-stat.com/charts.html?package=@hishprorg/aliquid-ut-debitis)
[![jsDelivr hits (npm)](https://img.shields.io/jsdelivr/npm/hw/@hishprorg/aliquid-ut-debitis)](https://www.jsdelivr.com/package/npm/@hishprorg/aliquid-ut-debitis)
...
```
npm install @hishprorg/aliquid-ut-debitis
```
...
import { supportTransform } from "@hishprorg/aliquid-ut-debitis";
...
```js
// EXAMPLES
import { getAttribute, hasAttribute, setAttribute } from "@hishprorg/aliquid-ut-debitis";
...
```js
// EXAMPLES
import { support3DTransform } from "@hishprorg/aliquid-ut-debitis";
...
```js
// EXAMPLES
import { addClass, removeClass, hasClass } from "@hishprorg/aliquid-ut-debitis";
...
```js
// EXAMPLES
import { on, off, one, passiveHandler } from "@hishprorg/aliquid-ut-debitis";
...
```js
// EXAMPLES
import { getElementAnimationDuration } from "@hishprorg/aliquid-ut-debitis";
...
```js
// EXAMPLES
import { isArray, isHTMLElement, isElementsArray } from "@hishprorg/aliquid-ut-debitis";
...
The **_Data_** and **_Timer_** utilities have their own specifics, you might want to check the [wiki](https://github.com/hishprorg/aliquid-ut-debitis/wiki).

```js
// EXAMPLES
import { emulateTransitionEnd, distinct } from "@hishprorg/aliquid-ut-debitis";
...
```js
// EXAMPLES
import { querySelector, querySelectorAll, documentAll, matches } from "@hishprorg/aliquid-ut-debitis";
...
```js
// EXAMPLES
import { on, off, one, mouseClickEvents, touchEvents, passiveHandler } from "@hishprorg/aliquid-ut-debitis";
...
```js
// Example
import on from "@hishprorg/aliquid-ut-debitis/src/event/on";
import addClass from "@hishprorg/aliquid-ut-debitis/src/class/addClass";
import getElementById from "@hishprorg/aliquid-ut-debitis/src/selectors/getElementById";
import mouseclickEvent from "@hishprorg/aliquid-ut-debitis/src/strings/mouseclickEvent";
...
**shorty** is released under the [MIT License](https://github.com/hishprorg/aliquid-ut-debitis/blob/master/LICENSE)
